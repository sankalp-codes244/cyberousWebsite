...
<Link to='/contact' className='w-full'>
      ...
      <div>
        <div className='text-center relative bg-no-repeat bg-cover bg-center h-full md:h-screen object-cover p-6 md:pt-20 px-16' style={{ backgroundImage: `url(${Images.internshipbg1})`, }}>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
              <p className='text-white font-__Inter_aaf875 text-lg  m-4 p-4 md:text-justify rounded-md  bg-custom-fontColor-Green'>
              ...
              <p className='text-white font-__Inter_aaf875 text-lg  p-4 md:text-justify m-4 rounded-md  bg-custom-fontColor-Green'>
              ...
              <p className='text-white font-__Inter_aaf875 text-lg  md:text-justify m-4 p-4 rounded-md  bg-custom-fontColor-Green'>
