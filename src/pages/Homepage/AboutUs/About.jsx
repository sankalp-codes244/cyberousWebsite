        ...
        <div className="w-full md:w-1/2 p-5 md:p-20 bg-custom-greyLightColor">
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-start items-center">
            ...
            <div className="grid grid-cols-1 gap-4 w-full">
              <h1 className="mt-2 md:mt-10 ml-10 text-4xl font-bold">
                Happy Clients
              </h1>
              <h1 className="text-custom-buttonColor-Green text-4xl font-bold m-2 mt-4 ml-10">
                1000 +
              </h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 w-full">
              <h1 className="m-2 text-4xl font-bold mt-10 ml-10">
                Projects Done
              </h1>
              <h1 className="text-custom-buttonColor-Green text-4xl font-bold mt-4  ml-10">
                50+
              </h1>
            </div>
          </div>
