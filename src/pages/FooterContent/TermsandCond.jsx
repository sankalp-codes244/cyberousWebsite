  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-700 mb-6">
          Unless otherwise stated, Cyberous and/or its licensors own the intellectual property rights for all material on Cyberous. All intellectual property rights are reserved. You may access this from Cyberous for your own personal use subjected to restrictions set in these terms and conditions.
        </p>
        <p className="text-lg text-gray-700 mb-6">
          You must not:
        </p>
        <ul className="text-lg text-gray-700 mb-6 list-disc ml-6">
          <li>Republish material from Cyberous</li>
          <li>Sell, rent or sub-license material from Cyberous</li>
          <li>Reproduce, duplicate or copy material from Cyberous</li>
          <li>Redistribute content from Cyberous</li>
        </ul>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Hyperlinking to our Content</h2>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <p className="text-lg text-gray-700 mb-6">
          We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Cyberous; and (d) the link is in the context of general resource information.
        </p>
        <p className="text-lg text-gray-700 mb-6">
          These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party’s site.
        </p>
        <p className="text-lg text-gray-700 mb-6">
          If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Cyberous. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
        </p>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Content Liability</h2>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Reservation of Rights</h2>
        <p className="text-lg text-gray-700 mb-6">
          We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it’s linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.
        </p>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Removal of links from our website</h2>
        <p className="text-lg text-gray-700 mb-6">
