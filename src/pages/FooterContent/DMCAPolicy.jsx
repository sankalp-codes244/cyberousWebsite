...
This Digital Millennium Copyright Act policy applies to the "www.cyberous.in" website (“Website” or “Service”) and any of its related products and services (collectively, “Services”) and outlines how this Website operator (“Operator”, “we”, “us” or “our”) addresses copyright infringement notifications and how you (“you” or “your”) may submit a copyright infringement complaint.
<br />
          <br />
...
<br />
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4">What to consider before submitting a copyright complaint</h2>
        <p className="text-lg text-gray-700 mb-6">
          ...
          <br />
          <br />
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Notifications of infringement</h2>
          <br />
          <br />
...
The process described in this Policy does not limit our ability to pursue any other remedies we may have to address suspected infringement.
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Reporting copyright infringement
</h2>
<p className="text-lg text-gray-700 mb-6">
