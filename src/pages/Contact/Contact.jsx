...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoader(false); // After form submission is complete
  };
          ...
          <div className=' lg:w-1/2'>
            <form id='myform' method='post' onSubmit={handleSubmit}  className='w-full  '>
              ...
              <div className='w-11/12 y-'>
                ...
                <select value={formData.question} onChange={handleChange} name='question' className='border border-solid border-black bg-white mx-4 h-10 w-full'>
              ...
              <div className='p-4  '>
                ...
                <textarea value={formData.message} onChange={handleChange} name='message' className='border border-solid border-black w-full h-64 font-serif text-black p-4' type='text' placeholder=''></textarea>
