    ...
    <div className='h-full'>
      ...
      <div className='bg-white'>
        ...
        <div className='flex flex-col text-center '>
          <h1 className='text-3xl lg:text-3xl  mt-4'> Our Services </h1>
          <div className='flex justify-center'>
            <div className="h-1 w-32 bg-custom-buttonColor-Green mt-4 rounded-full"></div>
          </div>
        ...
        <div className='flex justify-center'>
          <div className='w-2/3'>
            <p className=' m-6 mb-12 text-lg text-custom-fontColor-grey text-justify'>
