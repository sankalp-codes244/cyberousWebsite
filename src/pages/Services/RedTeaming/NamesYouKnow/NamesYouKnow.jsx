        ...
        <div>
            <div className=' md:p-10'>
                <div className='md:px-10 md:w-4/5'>
                    <h1 className='text-6xl md:text-8xl mr-3 md:mr-0 font-holtwood py-6 pl-4 text-left'>
                        NAMES YOU KNOW.<span className='text-orange-500'> IF WE COULD TELL YOU.</span>
                    </h1>
                    <div className='md:w-1/2'>
                        <p className='text-2xl text-start font-stylish pb-10 md:m-6  md:text-justify'>
