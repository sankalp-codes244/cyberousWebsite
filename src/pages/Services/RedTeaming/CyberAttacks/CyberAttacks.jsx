        ...
        <div className='mt-10'>
            <div className='md:flex '>
                ...
                <div className=' md:w-2/3 p-4  md:py-10 md:p-20'>
                    <h1 className='text-6xl md:text-8xl font-holtwood py-4'>
                        Red Team Services
                    </h1>
                    <h1 className='text-6xl md:text-6xl font-holtwood text-orange-500 py-2'>
                        Cyber Attacks
                    </h1>
            ...
            <div className='p-6 md:px-20 '>
                <div className='h-full grid grid-cols-1 md:grid-cols-3  p-10 '>
                    <div className=' p-4 md:p-10 hover:bg-orange-500 hover:text-white'>
                        <h1 className=' text-6xl md:text-5xl font-holtwood py-4'>
                            Digital
                        </h1>
