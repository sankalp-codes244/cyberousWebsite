...
const TestimonialCard = ({ image, name, title, desc }) => {
  return (
    <div className='p-6 relative lg:hover:scale-105 duration-300 '>
      <div className="w-full h-full lg:w-full  border border-solid rounded-lg bg-custom-greyLightColor shadow-lg ">
        <div className=''>
